    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{ backgroundColor: `${overlayBg}dd` }}
            />
            ...
            <div className="ft-container">
                ...
                <div className="ft-section ft-center">
                    ...
                    <div className="ft-contact-list">
                        {s?.contact_address && (
                            <div className="ft-contact-item" style={{ color: textMuted }}>
            ...
            >
                <p style={{ color: textMuted }}>
                    © {new Date().getFullYear()} {s?.site_name || 'PVT Enterprises'}. All Rights Reserved.
                </p>
            </div>
        </footer>
    );
